 ...
 * Signature: (JJJJIJIJIJJJJJJJJJLjava/lang/String;[DZZZ)J
 */
JNIEXPORT jlong JNICALL Java_hybrid_PrismHybrid_PH_1NondetProbQuantile
  (JNIEnv *, jclass, jlong, jlong, jlong, jlong, jint, jlong, jint, jlong, jint, jlong, jlong, jlong, jlong, jlong, jlong, jlong, jlong, jlong, jstring, jdoubleArray, jboolean, jboolean, jboolean);
