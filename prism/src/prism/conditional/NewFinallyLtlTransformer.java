...
public interface NewFinallyLtlTransformer<M extends ProbModel, C extends StateModelChecker> extends NewNormalFormTransformer<M, C>
{
...
//	public static final AcceptanceType[] ACCEPTANCE_TYPES = {AcceptanceType.RABIN, AcceptanceType.GENERALIZED_RABIN, AcceptanceType.STREETT};
	...
	public static class CTMC extends NewNormalFormTransformer.CTMC implements NewFinallyLtlTransformer<StochModel, StochModelChecker>
	{
