...
public class GUIPrism extends JFrame
{
	...
	private void initComponents() throws GUIException
	{
		...
		prismOptions.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_O);
		...
		fontIncrease.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_I);
		...
		fontDecrease.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_D);
