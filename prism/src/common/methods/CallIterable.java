...
public class CallIterable
{
	...
	public static <T> Mapping<Iterable<? extends T>, java.util.Iterator<? extends T>> iterator()
	{
		return (Mapping<Iterable<? extends T>, java.util.Iterator<? extends T>>) ITERATOR;
	}
