...
import common.iterable.MappingIterable.ToDouble;
import common.iterable.MappingIterable.ToInt;
import common.iterable.MappingIterable.ToLong;

//TODO: add stream support ?

public interface FunctionalIterable<E> extends Iterable<E>
{
	public class IterableDecorator<E, I extends Iterable<E>> implements FunctionalIterable<E>
	{
		protected final I iterable;

		public IterableDecorator(I iterable)
		{
	...
	public static <E> FunctionalIterable<E> extend(Iterable<E> iterable)
	{
		...
		return new IterableDecorator<E, Iterable<E>>(iterable);
	}
	...
	public static IterableDouble unboxDouble(Iterable<Double> iterable)
	{
		...
		return new ToDouble<>(iterable, Double::doubleValue);
	}
	...
	public static IterableLong unboxLong(Iterable<Long> iterable)
	{
		...
		return new ToLong<>(iterable, Long::longValue);
	}
