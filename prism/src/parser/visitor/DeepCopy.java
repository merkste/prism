...
public class DeepCopy extends DAGVisitor
{
	...
	@Override
	public DeclarationIntView visitNow(DeclarationIntView e) throws PrismLangException
	{
		return e.clone().deepCopy(this);
	}
	...
	@Override
	public ExpressionViewVar visitNow(ExpressionViewVar e) throws PrismLangException
	{
		return e.clone().deepCopy(this);
	}

	@Override
	public ExpressionConditional visitNow(ExpressionConditional e) throws PrismLangException
	{
		return e.clone().deepCopy(this);
	}
	...
	@Override
	public ExpressionHOA visitNow(ExpressionHOA e) throws PrismLangException
	{
		return e.clone().deepCopy(this);
	}
	...
	@Override
	public TemporalOperatorBound visitNow(TemporalOperatorBound e) throws PrismLangException
	{
		return e.clone().deepCopy(this);
	}

	@Override
	public TemporalOperatorBounds visitNow(TemporalOperatorBounds e) throws PrismLangException
	{
		return e.clone().deepCopy(this);
	}

	@Override
	public QuotedString visitNow(QuotedString e) throws PrismLangException
	{
		return e.clone().deepCopy(this);
	}
}
