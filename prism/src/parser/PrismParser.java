...
// (see ExpressionTemporal production for lookahead explanation)
  static final public 
TemporalOperatorBound BoundExpression() throws ParseException {Expression lBound, uBound;
...
{if ("" != null) return bound;}
  ...
  static final public TemporalOperatorBounds TemporalOpBounds() throws ParseException {TemporalOperatorBounds bounds = new TemporalOperatorBounds();
...
bounds.addBound(bound);
    ...
    jj_consume_token(RBRACE);
{if ("" != null) return bounds;}
    throw new Error("Missing return statement in function");
  }

  static final public TemporalOperatorBound TemporalOpBound() throws ParseException {TemporalOperatorBound bound = null;
...
Expression ExpressionBasic(boolean prop, boolean pathprop) throws ParseException {Expression ret;
    ...
    case QUANTILE_NF:{
      ret = ExpressionQuantileProbNormalForm(prop, pathprop);
      break;
      }
    case QUANTILE:{
      ret = ExpressionQuantileProb(prop, pathprop);
      break;
      }
    case EXP_QUANTILE:{
      ret = ExpressionQuantileExpNormalForm(prop, pathprop);
      break;
      }
    case RMAX:
    case RMIN:
...
//-----------------------------------------------------------------------------------
  static final public 
Expression ExpressionThresholdRange() throws ParseException {ExpressionThresholdRange threshold = null;
        Expression lower = null;
        Expression upper = null;
        Expression step = null;
    jj_consume_token(LBRACKET);
    lower = Expression(false, false);
    jj_consume_token(COLON);
    upper = Expression(false, false);
    jj_consume_token(COLON);
    step = Expression(false, false);
    jj_consume_token(RBRACKET);
threshold = new ExpressionThresholdRange(lower, upper, step);
     {if ("" != null) return threshold;}
    throw new Error("Missing return statement in function");
  }

  static final public Expression ExpressionThresholdAtom() throws ParseException {Expression threshold = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LBRACKET:{
      threshold = ExpressionThresholdRange();
      break;
      }
    case A:
    case E:
    ...
    case REG_IDENT:
    case REG_QUOTED_IDENT:{
      threshold = Expression(false,false);
      break;
      }
    default:
      jj_la1[75] = jj_gen;
...
// A probability threshold, either {p1,p2,...,pn} or simple p (p = double expression)
  static final public Expression ExpressionThreshold() throws ParseException {ExpressionMultipleThresholds thresholds = null;
        Expression threshold = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LBRACE:{
      jj_consume_token(LBRACE);
thresholds = new ExpressionMultipleThresholds();
      threshold = ExpressionThresholdAtom();
thresholds.addThreshold(threshold);
      label_29:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case COMMA:{
...
// (Property) expression: operator Quantile (probability quantile)
  static final public 
Expression ExpressionQuantileProbNormalForm(boolean prop, boolean pathprop) throws ParseException {Token begin;
    ExpressionQuantileProbNormalForm ret = new ExpressionQuantileProbNormalForm();
    Expression innerFormula;
    Object index;
if (!prop) {if (true) throw generateParseException();}
    begin = jj_consume_token(QUANTILE_NF);
    jj_consume_token(LPARENTH);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case EXISTENTIAL:{
...
ret.setUniversal();
    ...
    jj_consume_token(COMMA);
    innerFormula = ExpressionProb(prop, pathprop);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case COMMA:{
      jj_consume_token(COMMA);
      jj_consume_token(R);
...
ret.setPosition(begin, getToken(0));
       ...
       ret.setInnerFormula(innerFormula);
       {if ("" != null) return ret;}
    throw new Error("Missing return statement in function");
  }
...
// (Property) expression: operator Quantile (probability quantile)
  static final public 
Expression ExpressionQuantileProb(boolean prop, boolean pathprop) throws ParseException {Token begin;
    ExpressionQuantileProb ret = new ExpressionQuantileProb();
    Expression innerFormula;
    String quantileVariable;
if (!prop) {if (true) throw generateParseException();}
    begin = jj_consume_token(QUANTILE);
    jj_consume_token(LPARENTH);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case MIN:{
      jj_consume_token(MIN);
ret.setMinMax(explicit.MinMax.min());
      break;
      }
    case MAX:{
      jj_consume_token(MAX);
ret.setMinMax(explicit.MinMax.max());
      break;
      }
    default:
      jj_la1[88] = jj_gen;
    ...
    quantileVariable = Identifier();
    jj_consume_token(COMMA);
    innerFormula = ExpressionProb(prop, pathprop);
    jj_consume_token(RPARENTH);
ret.setPosition(begin, getToken(0));

       ret.setQuantileVariable(quantileVariable);
       ret.setInnerFormula(innerFormula);
       {if ("" != null) return ret;}
    throw new Error("Missing return statement in function");
  }

// (Property) expression: operator Quantile (expectation quantile)
  static final public 
Expression ExpressionQuantileExpNormalForm(boolean prop, boolean pathprop) throws ParseException {Token begin;
    ExpressionQuantileExpNormalForm ret = new ExpressionQuantileExpNormalForm();
    Object costRewardIndex;
    Object valueRewardIndex;
    Expression threshold;
if (!prop) {if (true) throw generateParseException();}
    begin = jj_consume_token(EXP_QUANTILE);
    jj_consume_token(LPARENTH);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case EXISTENTIAL:{
      jj_consume_token(EXISTENTIAL);
...
ret.setUniversal();
    ...
    jj_consume_token(COMMA);
    jj_consume_token(EXP_UTIL);
    jj_consume_token(R);
    valueRewardIndex = RewardIndex();
    jj_consume_token(GT);
    threshold = ExpressionThreshold();
    jj_consume_token(LPARENTH);
    jj_consume_token(R);
    costRewardIndex = RewardIndex();
    jj_consume_token(LE);
    jj_consume_token(QMARK);
    jj_consume_token(RPARENTH);
    jj_consume_token(RPARENTH);
ret.setPosition(begin, getToken(0));
       ...
       ret.setValueRewardStructIndex(valueRewardIndex);
       ret.setThresholdExpression(threshold);
       ret.setCostRewardStructIndex(costRewardIndex);
       {if ("" != null) return ret;}
    throw new Error("Missing return statement in function");
  }
...
// Reward specification for R operator
  static final public 
void RewardSpecification(ExpressionReward exprRew) throws ParseException {Object index = null;
...
exprRew.setRewardStructIndex(index);
  ...
  static final public Object RewardIndex() throws ParseException {Object index = null;
    jj_consume_token(LBRACE);
...
fl.setLHS(s);
 ...
 {
    if (jj_scan_token(UNIVERSAL)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(EXISTENTIAL)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(EXP_QUANTILE)) return true;
    if (jj_scan_token(LPARENTH)) return true;
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_206()) {
    ...
    if (jj_scan_token(COMMA)) return true;
    if (jj_scan_token(EXP_UTIL)) return true;
 ...
 {
    if (jj_scan_token(QUANTILE_NF)) return true;
    if (jj_scan_token(LPARENTH)) return true;
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_201()) {
  ...
  static private boolean jj_3R_170()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x514404c0,0x504404c0,0x1000000,0xb01a0848,0x0,0xb01a0848,0xb01a0848,0x0,0xb01a0848,0x400,0x40000000,0x80,0x40000480,0x8000210,0x8000210,0x0,0x40,0x0,0x1000000,0x0,0x0,0x8000030,0x0,0x2000000,0x0,0x0,0x0,0xa0ba0808,0x0,0x0,0x0,0xa0ba0808,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x