  ...
  static final public DeclarationType DeclarationVarType() throws ParseException {
    ...
    case VIEW:
      jj_consume_token(VIEW);
                    viewBitVars = new ArrayList<ExpressionVar>();
      jj_consume_token(LPARENTH);
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case REG_IDENT:
        bitVar = Identifier();
                                        {ExpressionVar v = new ExpressionVar(bitVar, null); viewBitVars.add(v);}
        label_6:
        while (true) {
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case COMMA:
      ...
      high = Expression(false, false);
      jj_consume_token(RBRACKET);
                  declType = new DeclarationIntView(low, high);
                  ((DeclarationIntView)declType).setBits(viewBitVars);
      break;
    default:
      jj_la1[21] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public Expression ExpressionTemporalBinary(boolean prop, boolean pathprop) throws ParseException {
    ...
    case W:
      ...
      case CARET:
        ...
        case LE:
        case GE:
          defaultBound = BoundExpression();
                                                        exprTemp.getBounds().setDefaultBound(defaultBound);
          break;
        case LBRACE:
        case CARET:
          bounds = TemporalOpBounds();
                                                   exprTemp.setBounds(bounds);
          break;
        default:
          jj_la1[41] = jj_gen;
          jj_consume_token(-1);
...
// (see ExpressionTemporal production for lookahead explanation)
  static final public TemporalOperatorBound BoundExpression() throws ParseException {
      ...
      if (jj_2_11(2147483647)) {
        ...
        default:
          ...
          throw new ParseException();
                                                                                                                                        ...
                                                                                                                                        bound.setUpperBound(uBound, false);
      break;
    case LT:
      jj_consume_token(LT);
      if (jj_2_12(2147483647)) {
        ...
        default:
          ...
          throw new ParseException();
                                                                                                                                        ...
                                                                                                                                        bound.setUpperBound(uBound, true);
      break;
    case GE:
      jj_consume_token(GE);
      if (jj_2_13(2147483647)) {
        ...
        default:
          ...
          throw new ParseException();
                                                                                                                                        ...
                                                                                                                                        bound.setLowerBound(lBound, false);
      break;
    case GT:
      jj_consume_token(GT);
      if (jj_2_14(2147483647)) {
        ...
        default:
          ...
          throw new ParseException();
                                                                                                                                        ...
                                                                                                                                        bound.setLowerBound(lBound, true);
      break;
    case LBRACKET:
      jj_consume_token(LBRACKET);
      lBound = Expression(false, false);
      ...
      uBound = Expression(false, false);
      jj_consume_token(RBRACKET);
                                                                                                                bound.setLowerBound(lBound, false); bound.setUpperBound(uBound, false);
      break;
    case EQ:
      jj_consume_token(EQ);
      lBound = Expression(false, false);
                                                     bound.setEqualBounds(lBound);
      break;
    default:
      jj_la1[52] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public TemporalOperatorBounds TemporalOpBounds() throws ParseException {
    ...
    jj_consume_token(RBRACE);
         {if (true) return bounds;}
    throw new Error("Missing return statement in function");
  }

  static final public TemporalOperatorBound TemporalOpBound() throws ParseException {
        TemporalOperatorBound bound = null;
        Object rewardIndex = null;
    if (jj_2_15(1)) {
      if (getToken(1).kind==REG_IDENT && getToken(1).image.equals("time")) {
      ...
      Identifier();
      bound = BoundExpression();
                                                                                                                                    bound.setBoundType(TemporalOperatorBound.BoundType.STEP_BOUND);
    } else if (jj_2_17(1)) {
  ...
  static final public Expression ExpressionBasic(boolean prop, boolean pathprop) throws ParseException {
    ...
    default:
      ...
      if (jj_2_18(2147483647)) {
        ret = ExpressionConditional(prop, pathprop);
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case PMAX:
        case PMIN:
...
// (Property) expression: conditional property
// @Deprecated: Use conditional operator || inside P, R, S expressions 
  static final public Expression ExpressionConditional(boolean prop, boolean pathprop) throws ParseException {
    ...
    case PMIN:
    case P:
      objective = ExpressionProb(prop, pathprop);
      break;
    case RMAX:
    case RMIN:
    case R:
      objective = ExpressionReward(prop, pathprop);
      break;
    case S:
      objective = ExpressionSS(prop, pathprop);
      break;
    default:
      jj_la1[76] = jj_gen;
      jj_consume_token(-1);
    ...
    jj_consume_token(LBRACKET);
    condition = Expression(prop, true);
    jj_consume_token(RBRACKET);
                ExpressionFilter filter = null;
                if (objective instanceof ExpressionFilter) {
                        // separate objective and old-style filter
                        filter = (ExpressionFilter) objective;
                        objective = filter.getOperand();
                }
                if (! (objective instanceof ExpressionQuant)) {
                        {if (true) throw new ParseException("Expected " + ExpressionQuant.class.getSimpleName());}
                }
                ...
                exprCond.setEndLine(getToken(0).endLine);
                exprCond.setEndColumn(getToken(0).endColumn);
                if (filter != null) {
                        // apply old-style filter to conditional expression
                        filter.setOperand(exprCond);
                        {if (true) return filter;}
                } else {
                        {if (true) return exprCond;}
                }
    throw new Error("Missing return statement in function");
  }
...
// (Property) expression: probabilistic operator P
  static final public Expression ExpressionProb(boolean prop, boolean pathprop) throws ParseException {
        ...
        Filter filter = null;
        Expression ret = null;
        ExpressionProb exprProb = new ExpressionProb();
        Token begin = null;
        boolean isBool;
          if (!prop) {if (true) throw generateParseException();}
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    ...
    jj_consume_token(RBRACKET);
                exprProb.setModifier(modifier == null ? null : modifier.getName());
                exprProb.setRelOp(relOp);
                exprProb.setMinMax(minMax);
                exprProb.setProb(prob);
                exprProb.setExpression(expr);
                exprProb.setFilter(filter);
                exprProb.setPosition(begin, getToken(0));
                if (condition != null) {
                        ret = new ExpressionConditional((ExpressionQuant) exprProb, condition);
                } else {
                        ret = exprProb;
                }
...
//  - a (possibly negated) HOA: ... automaton specification
  static final public Expression PathSpecification(boolean prop) throws ParseException {
        Expression result;
...
// The inner part of a HOA: { "automatonfile", "ap" <- state-expression, ... } specification
  static final public ExpressionHOA PathSpecificationHOA(boolean prop) throws ParseException {
...
// Filter for a P/S/R operator
  ...
  static final public Expression ExpressionLongRun(boolean prop, boolean pathprop) throws ParseException {
    ...
    jj_consume_token(RBRACKET);
                ...
                if (condition == null) {
                        {if (true) return exprLongRun;}
                }
                {if (true) return new ExpressionConditional(exprLongRun, condition);}
    throw new Error("Missing return statement in function");
  }
...
// (Property) expression: steady-state operator S
  static final public Expression ExpressionSS(boolean prop, boolean pathprop) throws ParseException {
        ...
        Filter filter = null;
        Expression ret = null;
        ExpressionSS exprSS = new ExpressionSS();
        Token begin;
        boolean isBool;
          if (!prop) {if (true) throw generateParseException();}
    ...
    jj_consume_token(RBRACKET);
                exprSS.setModifier(modifier == null ? null : modifier.getName());
                exprSS.setRelOp(relOp);
                exprSS.setProb(prob);
                exprSS.setExpression(expr);
                exprSS.setFilter(filter);
                exprSS.setPosition(begin, getToken(0));
                if (condition != null) {
                        ret = new ExpressionConditional((ExpressionQuant) exprSS, condition);
                } else {
                        ret = exprSS;
                }
                // Filter is actually dealt with by wrapping this expression in
...
// (Property) expression: expected reward operator R
  static final public Expression ExpressionReward(boolean prop, boolean pathprop) throws ParseException {
        ...
        Filter filter = null;
        Expression ret = null;
        ExpressionReward exprRew = new ExpressionReward();
        Token begin;
        boolean isBool;
          if (!prop) {if (true) throw generateParseException();}
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    ...
    jj_consume_token(RBRACKET);
                exprRew.setModifier(modifier == null ? null : modifier.getName());
                exprRew.setMinMax(minMax);
                exprRew.setRelOp(relOp);
                exprRew.setReward(rew);
                exprRew.setExpression(expr);
                exprRew.setFilter(filter);
                exprRew.setPosition(begin, getToken(0));
                if (condition != null) {
                        ret = new ExpressionConditional((ExpressionQuant) exprRew, condition);
                } else {
                        ret = exprRew;
                }
                // Filter is actually dealt with by wrapping this expression in
...
// Reward specification for R operator
  static final public void RewardSpecification(ExpressionReward exprRew) throws ParseException {
        Object index = null;
    ...
    if (jj_2_23(2147483647)) {
      ...
      default:
        ...
        if (jj_2_24(2147483647)) {
          ...
          jj_consume_token(LE);
          expr = Expression(false, false);
                                                                                 exprTemp = new ExpressionTemporal(ExpressionTemporal.R_C, null, null); b.setUpperBound(expr); exprTemp.getBounds().setDefaultBound(b); ret = exprTemp;
        } else {
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case C:
            jj_consume_token(C);
          ...
          case I:
            ...
            jj_consume_token(EQ);
            expr = Expression(false, false);
                                                     exprTemp = new ExpressionTemporal(ExpressionTemporal.R_I, null, null); b.setUpperBound(expr); exprTemp.getBounds().setDefaultBound(b); ret = exprTemp;
            break;
          case A:
          case E:
          case FALSE:
...
// (Property) expression: label (including "init")
  static final public Expression ExpressionLabel(boolean prop, boolean pathprop) throws ParseException {
    ...
    // Label can be arbitary quoted identifier
          ...
          ret = new ExpressionLabel(qi.getName()); ret.setPosition(qi,qi); {if (true) return ret;}
    throw new Error("Missing return statement in function");
  }
...
// (Property) expression: filter (using "filter" keyword)
  static final public Expression ExpressionFilter(boolean prop, boolean pathprop) throws ParseException {
    ...
    case LPARENTH:
      jj_consume_token(LPARENTH);
      qs = QuotedString();
                                operatorArguments = new ArrayList<QuotedString>(); operatorArguments.add(qs);
      label_32:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case COMMA:
    ...
    jj_consume_token(RPARENTH);
                // transform legacy filter CLR to AVG of L operator over "init"
                if (op.equals("clr")) {
                        Expression states = (filter == null) ? Expression.True() : filter;
                        if (expr2 instanceof ExpressionQuant) {
                                ExpressionQuant<?> quant = (ExpressionQuant<?>) expr2;
                                RelOp relop              = quant.getRelOp();
                                Expression bound         = quant.getBound();
                                quant.setRelOp(RelOp.COMPUTE_VALUES);
                                quant.setBound(null);
                                expr2                 = new ExpressionLongRun(quant, states, relop, bound);
                        } else {
                                RelOp relop      = RelOp.COMPUTE_VALUES;
                                Expression bound = null;
                                expr2            = new ExpressionLongRun(expr2, states, relop, bound);
                        }
                        op                    = "avg";
                        filter                = new ExpressionLabel("init");
                }
                expr = new ExpressionFilter(op, expr2, filter);
                expr.setPosition(begin, getToken(0));
                expr.setOperatorArguments(operatorArguments);
...
// QuotedIdentifier (returns ExpressionIdent, storing position info)
  static final public ExpressionIdent QuotedIdentifierExpression() throws ParseException {
        String ident;
        ExpressionIdent ret;
        Token begin;
         begin = getToken(1);
    ident = QuotedIdentifier();
          ret = new ExpressionIdent(ident); ret.setPosition(begin, getToken(0)); {if (true) return ret;}
    throw new Error("Missing return statement in function");
  }

// A quoted string ("text"), returns the unquoted text
  static final public QuotedString QuotedString() throws ParseException {
        String s;
        Token begin;
         begin = getToken(1);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    ...
    default:
      ...
      throw new ParseException();
                ...
                try {
                        {if (true) return QuotedString.fromQuoted(s);}
                } catch (PrismLangException e) {
...
// For loop
  ...
  static private boolean jj_3_9() {
    if (jj_scan_token(TBAR)) return true;
    return false;
  }
  ...
  static private boolean jj_3R_56() {
    if (jj_scan_token(DBAR)) return true;
  ...
  static private boolean jj_3R_247() {
    if (jj_scan_token(CLR)) return true;
    return false;
  }
  ...
  static private boolean jj_3_17() {
    jj_lookingAhead = true;
    jj_semLA = getToken(1).kind==REG_IDENT && getToken(1).image.equals("reward");
    jj_lookingAhead = false;
  ...
  static private boolean jj_3_16() {
    jj_lookingAhead = true;
    jj_semLA = getToken(1).kind==REG_IDENT && getToken(1).image.equals("steps");
    jj_lookingAhead = false;
  ...
  static private boolean jj_3_15() {
    jj_lookingAhead = true;
    jj_semLA = getToken(1).kind==REG_IDENT && getToken(1).image.equals("time");
    jj_lookingAhead = false;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x228808c0,0x208808c0,0x2000000,0xe0341048,0x0,0xe0341048,0xe0341048,0x0,0xe0341048,0x800,0x0,0x80,0x880,0x10000410,0x10000410,0x0,0x40,0x0,0x2000000,0x0,0x0,0x10000030,0x0,0x4000000,0x0,0x0,0x0,0xc1741008,0x0,0x0,0x0,0xc1741008,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1400000,0x0,0x0,0xc1741008,0xc1741008,0xc1741008,0xc1741008,0xc1741008,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc0341008,0x0,0x0,0x0,0x0,0x0,0x0,0xc0341008,0x80240000,0x40101008,0x0,0x80000000,0x80000000,0x0,0x40000,0x0,0x0,0x80000000,0x80000000,0x0,0x0,0x0,0x0,0xc1741008,0x0,0x0,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x80000000,0x0,0x0,0x0,0x0,0x0,0xc1741008,0x0,0xc9741208,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000100,0x0,0x0,0x0,0x0,0x80000000,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x61f15,0x20f11,0x41004,0x89eae2,0x0,0x89eae2,0x89eae2,0x0,0x89eae2,0x100,0x11,0x20000,0x20511,0x0,0x0,0xa00,0xa00,0x0,0x0,0x0,0x0,0x200000,0x0,0x0,0x0,0x0,0x0,0x89e0ea,0x1000000,0x80000,0x0,0x89e0ea,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x508000,0x0,0x0,0x508000,0x8,0x0,0x0,0x89e0ea,0x89e0ea,0x89e0ea,0x89e0ea,0x89e0ea,0x0,0x0,0x0,0x0,0x0,0x10000000,0x20000000,0x8000000,0x1000000,0x89e0e2,0x0,0x0,0x0,0x0,0x0,0x0,0x9e0e2,0x80002,0x1e0e0,0x0,0x2,0x2,0x0,0x80000,0x1e0e0,0x0,0x2,0x2,0xe0,0x0,0x0,0x4000000,0x89e0ea,0x0,0x0,0x2,0x0,0x4000000,0x0,0x0,0x0,0x4000000,0x0,0x0,0x2,0x2,0xe000,0x0,0x0,0x4000000,0x0,0x89e0ea,0x10000,0x89e0ea,0x0,0xe0e0,0xe0e0,0x0,0x0,0x0,0x0,0x9000002,0x0,0x0,0x0,0x0,0x2,0x0,0x0,0x80000000,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0xd8108088,0x1,0xd8108088,0xd8108088,0x1,0xd8108088,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x800,0x0,0x2,0x40000000,0x20,0x40000000,0x0,0x20,0x40000000,0x80000,0xd8108088,0x0,0x8,0x2,0xd81080a8,0x40000000,0x20,0x2,0x400200,0x2,0x2,0x400200,0xc0000008,0x0,0x4066a20,0x4066a20,0x0,0x0,0x4066a20,0x4066a20,0xd8108088,0xd8108088,0xd8108088,0xd8108088,0xd8108088,0x66820,0x4000000,0x2,0x200,0x2000000,0x0,0x0,0x0,0x0,0xd8108088,0x1800,0x66000,0x180000,0x180000,0x600000,0x600000,0xd8108088,0x58000008,0x80008080,0x8,0x0,0x40000000,0x2,0x18000000,0x0,0x8,0x0,0x0,0x0,0x66800,0x200,0x0,0xd8108088,0x2,0x200,0x0,0x66800,0x0,0x8,0x66808,0x200,0x0,0x8,0x200,0x0,0x0,0x0,0x66800,0x200,0x0,0x400000,0xd8108088,0x0,0xd8108088,0x8080,0x0,0x8,0x2,0x48000000,0x200000,0x48000000,0x40080000,0x2,0x8,0x2,0x80000000,0x40000000,0x1800,0x66000,0x0,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x0,};
   }
