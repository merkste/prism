    ...
    jj_consume_token(RPARENTH);
                ...
                if (op.equals("clr")) {
                        if (! (expr2 instanceof ExpressionQuant)) {
                                {if (true) throw new ParseException("Filter clr expects " + ExpressionQuant.class.getSimpleName());}
                        }
